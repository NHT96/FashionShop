...
<body id="page-top">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 mb-4">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="text" class="form-control product-name" value="">
                                        </div>
                                        <div class="form-group mb-4">
                                            <label>Giá</label>
                                            <div class="d-flex align-items-center">
                                                <input type="number" class="form-control product-price" value="" min="0" step="1000">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-12 mb-4">
                                        ...
                                        <div class="form-group mb-4">
                                            <textarea class="form-control product-description" id="product-desciptions" rows="8" cols="50"></textarea>
                                        </div>
	...
	<script type="text/javascript">
        ...
        $('.save-change').click(function() {
            ...
            $.post('/Java_FashionShop/admin/addProduct', {
            	name: name,
            	price: price,
